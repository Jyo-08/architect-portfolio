  ...
  const pillars = [
    {
      ...
      detail: 'Postgraduate city planning foundation (1999, CGPA 7.99) uniting regional spatial analytics, infrastructure frameworks, and demographic modeling.'
    },
    {
      icon: Map,
      title: 'Statutory City Planning & GIS',
      detail: 'Lead planner for key regional projects including AMRUT 2.0 GIS Master Plans in Tamil Nadu and JNPA Master Plan DCPR preparations in Navi Mumbai.'
    },
    {
      icon: Landmark,
    ...
    },
    {
      ...
      detail: 'Registered with Council of Architecture (COA New Delhi CA/98/24015), ITPI, IIA, DTCP, and Registered Valuer (IIV Pune CAT-I-F-8356).'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col mb-12">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-xs font-mono tracking-[0.25em] text-[#D9383A] uppercase">
                CHAPTER 03 // PROFILE &amp; MONOGRAPH
              </span>
            </div>
            <h1 className="font-serif text-3xl sm:text-5xl md:text-6xl font-bold text-[#F5F5F3] leading-[1.15] max-w-5xl uppercase">
              Profile
            </h1>
            <p className="mt-4 text-[#9AA0AC] max-w-2xl text-base sm:text-lg font-light">
              Ar. Nenmeli Jayaraman — Architecture, City Planning, Academic Leadership &amp; Practice.
            </p>
          </div>

          {/* V3 Editorial Feature Image: quotes.jpeg with engineered Left-side Text Safe Area */}
          <ProfileEditorial />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mt-8">
            ...
            >
              ...
              <p>
                Holding a Postgraduate Degree in City Planning from the <span className="text-[#F5F5F3] font-normal">Indian Institute of Technology (IIT) Kharagpur</span> (1999, CGPA 7.99) and a Bachelor of Architecture from the <span className="text-[#F5F5F3] font-normal">University of Madras</span> (GATE qualified), his professional journey bridges technical rigor with contextual spatial planning.
              </p>
              <p>
                As Proprietor and Chief Architect of <span className="text-[#F5F5F3] font-normal">Sri Janaki &amp; Associates</span> (Chengalpattu), he has directed the comprehensive planning, municipal sanctions, and construction of residential schemes, institutional layouts, and commercial developments across Tamil Nadu.
              </p>
              <p>
                His regional consultancy portfolio includes serving as Senior Urban Planner &amp; Team Leader for the <span className="text-[#F5F5F3] font-normal">Jawaharlal Nehru Port Authority (JNPA) Master Plan</span> with Voyants Solutions, formulating GIS-based statutory master plans under the <span className="text-[#F5F5F3] font-normal">AMRUT 2.0 Sub-Scheme</span> for Tamil Nadu cities with Capital Engineering Consultancy, and early research at the <span className="text-[#F5F5F3] font-normal">Operations Research Group (ORG)</span>.
              </p>
              <p>
              ...
              {/* Verified Professional Practice Card Identity Source */}
              <div className="pt-6 mt-8 border border-white/10 bg-[#111319] p-6 space-y-3">
                <div className="flex items-center justify-between pb-3 border-b border-white/10">
                  <span className="text-xs font-mono text-[#D9383A] tracking-widest uppercase">
                    PRACTICE IDENTITY SOURCE // SRI JANAKI &amp; ASSOCIATES
                  </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono text-[#CDD0D8]">
                  <div>
                    ...
                    <p className="text-[11px] text-[#9AA0AC] mt-0.5">B.Arch, A.I.I.A., M.C.P. (IIT-KGP), A.I.T.P.</p>
                  </div>
                  <div>
                    <span className="text-[#9AA0AC] block text-[10px] uppercase">Registered Office:</span>
                    <span className="text-[#F5F5F3]">No. 81 B, Rajaji Street, Chengalpattu, Chengalpattu District - 603001</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {pillars.map((pillar, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 flex items-center justify-center bg-[#171A22] border border-white/10 text-[#D9383A] mb-3">
              ...
              <div className="border border-white/10 bg-[#111319] p-6 space-y-4">
                <div className="flex items-center gap-2 text-xs font-mono text-[#D9383A] uppercase tracking-widest">
                  ...
                  <span>Technical Project Document Record</span>
                </div>
                <h4 className="font-serif text-base font-bold text-[#F5F5F3]">
                  Proposed Residential Building — Nenmeli Village
                </h4>
                <p className="text-xs text-[#9AA0AC] leading-relaxed">
                  Documented municipal sanctioned architectural drawings signed under Sri Janaki &amp; Associates by Ar. N. Jayaraman (Chengalpattu District).
                </p>
